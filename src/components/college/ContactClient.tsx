        ...
        <div className="container py-12">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-5">
                ...
                contacts.map((contact, i) => (
                  ...
                  >
                    <Card variant="default" className="p-6">
                      ...
                      <h3 className="text-sm font-bold text-slate-900 mb-4">{contact.department}</h3>
              ...
              {/* Helpline Card */}
              <Card variant="default" className="p-5 bg-blue-600 border-blue-700 text-white shadow-[0_4px_20px_rgba(37,99,235,0.25)] hover:border-blue-600">
                <div className="flex items-start gap-3">
                  <Sparkles className="w-5 h-5 text-blue-200 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-bold text-xs mb-1 uppercase tracking-wider">Admissions Helpline</h4>
            ...
            <div>
              <Card variant="default" className="overflow-hidden">
                <div className="bg-slate-100/80 px-4 py-3 flex items-center gap-2 border-b border-slate-200">
                ...
                {/* Quick Info Row */}
                <div className="border-t border-slate-200 grid grid-cols-2 divide-x divide-slate-200 text-center">
                  <div className="p-4">
