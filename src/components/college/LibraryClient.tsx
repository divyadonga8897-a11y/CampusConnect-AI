...
import { BookOpen, Users2, Laptop, ScrollText, Clock } from "lucide-react";
            ...
            <>
              ...
              <div className="grid lg:grid-cols-2 gap-8 mb-10">
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <h2 className="heading-card text-slate-900">{libraryData.title}</h2>
                  <p className="text-sm text-slate-500 leading-relaxed">{libraryData.description}</p>

                  {/* Quick Stat Chips */}
                  <div className="flex flex-wrap gap-2 pt-2">
                    <span className="badge badge-blue">{libraryData.book_count?.toLocaleString()}+ Books</span>
                    <span className="badge badge-green">{libraryData.digital_resources?.length}+ Digital Resources</span>
                    <span className="badge badge-amber">{libraryData.seating_capacity} Seats</span>
                  </div>
                </motion.div>
              </div>
              ...
              {libraryData.facilities && libraryData.facilities.length > 0 && (
                <div className="mb-8">
                  <SectionHeader eyebrow="Services" title="Library" highlight="Facilities" className="mb-6" />
              ...
              {libraryData.digital_resources && libraryData.digital_resources.length > 0 && (
                <div className="card p-6">
                  <h2 className="text-base font-bold text-slate-900 mb-4 flex items-center gap-2">
                    <Laptop className="w-4 h-4 text-blue-600" /> Digital Resources
                  </h2>
