                    ...
                    >
                      ...
                      <div className="relative h-44 overflow-hidden bg-slate-100 shrink-0">
                        ...
                        <div className="absolute bottom-3 left-3">
                          <Badge variant="filled" color={bColor}>
                            {dept.short_name}
                          </Badge>
                        </div>
                      </div>
                      ...
                      <div className="p-5 flex flex-col flex-grow">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-center mb-5 py-3 border-y border-slate-100 shrink-0 text-[10px] font-bold uppercase tracking-wider text-slate-400">
                          <div>
                        ...
                        <Button
                          variant="secondary"
                          size="sm"
                          className="w-full justify-center group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600"
                        >
