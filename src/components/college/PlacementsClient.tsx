              ...
              {loading ? (
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {filteredRecs.map((rec) => (
                    ...
                    >
                      <Card variant="default" className="flex flex-col h-full p-5 hover:border-blue-400 group">
                        ...
                        <Badge variant="light" color="slate" className="mb-3 mx-0 w-fit">
                          {rec.industry}
                        </Badge>
                        ...
                        {rec.hiring_roles && rec.hiring_roles.length > 0 && (
                          <div className="flex flex-wrap gap-1.5 pt-3.5 border-t border-slate-100 mt-auto shrink-0">
                            {rec.hiring_roles.slice(0, 3).map((role, idx) => (
                              <span key={idx} className="badge badge-green text-[9px]">{role}</span>
                            ))}
                          </div>
                        )}
                      </Card>
            ...
            <div className="lg:col-span-5 space-y-6">
                ...
                <div className="relative border-l-2 border-slate-200 ml-4.5 pl-6.5 space-y-6">
                  {processSteps.map((step, i) => (
                    ...
                    >
                      ...
                      <Card variant="default" className="p-4 hover:border-blue-400">
                        <h3 className="text-xs font-bold text-slate-900 mb-1 leading-snug">{step.step_title}</h3>
              ...
              <div className="space-y-3 mt-8">
                {[
                  ...
                  <Card key={l.href} clickable onClick={() => router.push(l.href)} className="p-4 flex items-center justify-between group">
                    <div>
                      <div className="text-xs font-bold text-slate-900 group-hover:text-blue-600 transition-colors leading-none mb-1">{l.label}</div>
