        ...
        <div className="container py-12">
            ...
            <AnimatePresence mode="popLayout">
              {gallery.map((item, idx) => (
                <motion.div
                  ...
                  className="relative aspect-[4/3] overflow-hidden rounded-xl cursor-pointer group bg-slate-200 border border-slate-200/50"
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-3 bg-gradient-to-t from-slate-950/80 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300 pointer-events-none">
                    <p className="text-white text-xs font-semibold leading-none">{item.title}</p>
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          {gallery.length === 0 && (
            <div className="card p-12 text-center max-w-sm mx-auto">
              ...
              <p className="text-slate-500 text-xs font-semibold">No images in this category.</p>
            </div>
          )}
        </div>
      </main>
