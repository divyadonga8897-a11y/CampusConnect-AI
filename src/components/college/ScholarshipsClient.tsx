      ...
      <main className="bg-slate-50 min-h-screen">
        ...
        <div className="container py-12">
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-4 p-5 text-left cursor-pointer bg-white hover:bg-slate-50/50 transition-colors"
                      >
          ...
          <div className="mt-10 max-w-3xl mx-auto">
            <Card variant="default" className="p-6 text-center border-blue-100 bg-blue-50/50">
